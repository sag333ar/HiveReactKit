...
class ActivityService {
  ...
  async getUserPosts(
    ...
    return this.getUserChannel(username, "posts", limit);
  }
  ...
  async getUserComments(
    ...
    return this.getUserChannel(username, "comments", limit);
  }
  ...
  async getUserReplies(
    ...
    return this.getUserChannel(username, "replies", limit);
  }
  ...
  getActivitySummary(activities: UserChannelItem[]): {
    ...
    return {
      ...
      averageVotes:
        activities.length > 0 ? Math.round(totalVotes / activities.length) : 0,
    };
  }
