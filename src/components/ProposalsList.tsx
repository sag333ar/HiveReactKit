          ...
          return (
            <>
              {activeProposals.map((p) => (
                <div key={p.proposal_id} className="border border-gray-200 dark:border-gray-700 rounded-lg mb-4 p-2 sm:p-4 shadow bg-white dark:bg-gray-800">
              ...
              {upcomingProposals.length > 0 && (
                <>
                  <div className="my-6 text-center">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Upcoming proposals</h3>
                    <p className="text-gray-600 dark:text-gray-400">The proposals listed below will start in the future. You can already support them.</p>
                  </div>
