...
const WitnessFiltersComponent: React.FC<WitnessFiltersProps> = ({ filters, onFiltersChange }) => {
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 mb-6">
      ...
      <div className="mb-6">
        <h4 className="text-sm font-medium text-gray-300 mb-3">WITNESS</h4>
        <div className="space-y-2">
          ...
          <label className="flex items-center space-x-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500 focus:ring-2"
            />
            <span className="text-white">Disabled/Stale</span>
          </label>
          <label className="flex items-center space-x-2 cursor-pointer">
            <input
              type="checkbox"
      ...
      {/* NAME Filter */}
      <div className="mb-6">
        <h4 className="text-sm font-medium text-gray-300 mb-3">NAME</h4>
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-700 border-b border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
          />
        </div>
      </div>
      ...
      {/* VERSION Filter */}
      <div>
        <h4 className="text-sm font-medium text-gray-300 mb-3">VERSION</h4>
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
