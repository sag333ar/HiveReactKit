...
export function VoteSlider({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 px-4 sm:items-center">
      <div className="bg-[var(--hrk-bg-surface-raised)] border border-[var(--hrk-border-default)] rounded-t-[16px] sm:rounded-[16px] w-full max-w-md p-5 sm:p-6 shadow-[var(--hrk-shadow-lg)] flex flex-col">
        {/* Header */}
